...
public class SmallRyeHealthArchiveProcessor implements ApplicationArchiveProcessor {
    ...
    public void process(Archive<?> applicationArchive, TestClass testClass) {
        if (applicationArchive instanceof WebArchive) {
            ...
            //                    "io.smallrye:smallrye-health-tck-mp5",
            ...
            testDeployment.addClasses(SmallRyeHealthServlet.class, SmallRyeLivenessServlet.class,
                    SmallRyeReadinessServlet.class,
                    SmallRyeStartupServlet.class, org.eclipse.microprofile.health.tck.TCKBase.class);
        }
    }
